    ...
    <section id="contact" className="relative overflow-hidden border-b border-black/5 bg-surface px-5 py-20 sm:px-8 sm:py-24">
      ...
      <Reveal className="mx-auto flex max-w-3xl flex-col items-center text-center">
        ...
        <a
          ...
          className="mt-8 flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-brand-red to-brand-red-dark px-8 py-4 text-base font-bold text-white shadow-lg shadow-brand-red/20 transition-transform hover:scale-105 active:scale-95"
        >
